...
if($user->uid) { # User... begin request process
...
} else { # Not a user... start public landing page
  echo "Thanks for using DueNorth! It appears that you are not a logged in user. To make an interlibrary loan request please login with your DueNorth account or print this page and visit your <a href='https://duenorth.nnyln.org/illdir' target='_blank'>local participating DueNorth library</a>. ";
  echo "A participating library would be happy to assist you in requesting these materials.<br>";
  echo "<br>";
}
