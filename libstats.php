...
$enddate = convertDate($enddated);
 ...
 #Get total requests
$GETREQUESTCOUNTSQLL= "SELECT * FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59' ";
$retval = mysqli_query($db, $GETREQUESTCOUNTSQLL);
$row_cnt = mysqli_num_rows($retval);

 #Get total filled requests
$FINDFILL= "SELECT * FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'     and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'  and  Fill =1 ";
...
$FINDNOTFILL= "SELECT * FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'  and  Fill =0 ";
...
$FINDEXPIRE= "SELECT * FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'  and  Fill =4 ";
...
$FINDNOANSW= "SELECT * FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'  and  Fill =3 ";
...
$CANANSW= "SELECT * FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'    and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'  and  Fill =6 ";
...
$libname =  $row["Name"];
   ...
   $destsystem=" SELECT distinct (`DestSystem` )  FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'   and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'  ";
   $destsystemq = mysqli_query($db, $destsystem);
    ...
    while ($row = mysqli_fetch_assoc($destsystemq)) {
        ...
        $destsystemcount=" SELECT `itype`  FROM `SENYLRC-SEAL2-STATS` WHERE `Requester LOC` LIKE '$loc'   and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'  ";
...
if (strcmp($dessysvar,'CVES')==0){
   ...
   $dessysvartxt = "Northern New York Library Network";
        ...
        $destitype=" SELECT distinct (`itype` )  FROM `SENYLRC-SEAL2-STATS`  WHERE `Requester LOC` LIKE '$loc'    and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59' ";
        ...
        while ($row2 = mysqli_fetch_assoc($destitypeq)) {
            ...
            $destitemcount=" SELECT `fill`  FROM `SENYLRC-SEAL2-STATS` WHERE `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'";
           ...
           $percent_friendly_typesys = number_format($percenttypesys_rows * 100, 2 ) . '%';
            ...
            $destitemcountfill=" SELECT `fill`  FROM `SENYLRC-SEAL2-STATS` WHERE Fill='1' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'   and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'";
           ...
           $percent_friendly_1 = number_format($percent1_rows * 100, 2 ) . '%';
            ...
            $destitemcountunfill=" SELECT `fill`  FROM `SENYLRC-SEAL2-STATS` WHERE Fill='0' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'   and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'";
           ...
           #Find what the expire rate is
            $destitemcountexfill=" SELECT `fill`  FROM `SENYLRC-SEAL2-STATS` WHERE Fill='4' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'";
           ...
           #Find what the cancel rate is
            $destitemcountcanfill=" SELECT `fill`  FROM `SENYLRC-SEAL2-STATS` WHERE Fill='6' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'";
           ...
           $percent_friendly_4 = number_format($percent4_rows * 100, 2 ) . '%';
            ...
            $destitemcountnoanswfill=" SELECT `fill`  FROM `SENYLRC-SEAL2-STATS` WHERE Fill='3' and `Itype`='$dessysitype' and `Requester LOC` LIKE '$loc'  and `DestSystem`='$dessysvar' and `Timestamp` >= '$startdate 00:00:00' and `Timestamp` <= '$enddate 11:59:59'";
